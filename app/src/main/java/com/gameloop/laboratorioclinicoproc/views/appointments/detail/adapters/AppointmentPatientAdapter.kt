...
class AppointmentPatientAdapter(private val listener: AppointmentPatientAdapter.Listener)
    ...
    class ViewHolder private constructor(private val binding: ListItemAppointmentPatientBinding)
        : RecyclerView.ViewHolder(binding.root) {
            ...
            fun bind(patientAppointments: Pair<Patient, List<LabTest>>, listener: Listener) {
